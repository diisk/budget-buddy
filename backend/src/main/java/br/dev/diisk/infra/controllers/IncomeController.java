...
import br.dev.diisk.application.mappers.income_category.IncomeCategoryToResponseMapper;
...
public class IncomeController {
    ...
    public IncomeController(IncomeCategoryToResponseMapper incomeCategoryToResponseMapper,
            ...
            IAddIncomeCategoryCase addIncomeCategoryCase, IResponseService responseService,
            IListIncomesCategoriesCase listIncomesCategoriesCase, IListIncomesCase listIncomesCase) {
        ...
        this.addIncomeCategoryCase = addIncomeCategoryCase;
